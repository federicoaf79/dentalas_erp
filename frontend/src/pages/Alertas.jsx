...
// v4 (11/8/2026 → removida el 21/8/2026 al reescribir para el filtro
//     automático de exclusiones): exclusión manual por SKU, dos
//     mecanismos reversibles (mismo patrón que la papelera de
//     OrdenesPropias) -- Exclusión PERMANENTE (articulos_excluidos_
//     alertas, admin-only, motivo obligatorio) y Pausa TEMPORAL de 15
//     días (alertas_pausadas, cualquier usuario). Las 2 tablas nunca
//     se borraron -- contadores_sidebar() las sigue leyendo desde el
//     21/8/2026 (ver 20260821150000_fix_contadores_sidebar_
//     exclusiones.sql) -- solo el frontend de Alertas.jsx las perdió.
// v5 (4/9/2026), ítem #48: Federico confirmó reactivar v4 tal cual
//     estaba. Reincorporada acá, conviviendo con lo que se agregó
//     después (exclusión automática de esExcluidoDeAlertas() -- item
...
export default function Alertas() {
  ...
  // 'pausadas' son las pestañas de exclusión manual (ítem #48).
  ...
  // Modal de exclusión/pausa (ítem #48), mismo patrón que
  // OrdenesPropias.jsx: { tipo: 'excluir'|'pausar'|'restaurar'|'reactivar', articulo|fila }
  ...
  const conAlertaTodas = useMemo(() => {
    return articulos
      ...
      // Exclusión manual (ítem #48): permanentes y pausas VIGENTES no
      // cuentan como alerta. Una pausa vencida vuelve a contar sola,
      // sin acción de nadie.
